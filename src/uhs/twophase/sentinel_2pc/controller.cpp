...
namespace cbdc::sentinel_2pc {
    ...
    controller::send_compact_tx(const transaction::compact_tx& ctx,
        ...
        std::string dtx_hex_insert = "INSERT INTO admin.transaction (transactionhash, payee) SELECT tx_hash, payee_to FROM admin.transactionholder WHERE tx_hash = '" + dtx_hex + "'";
